$PBExportHeader$inh311_cvoinstancevar.sra
$PBExportComments$Generated Application Object
forward
global type inh311_cvoinstancevar from application
end type
...
global variables
STring gs_pb, gs_js
w_inh311w01_cvoinstancevar gw_inh311w01_cvoinstancevar
...
string  gs_WinName[] = {"w_inh311w01_cvoinstancevar"}
//END_GLOBALVAR
end variables

global type inh311_cvoinstancevar from application
string appname = "inh311_cvoinstancevar"
event ue_cotopen ( string as_commandline )
end type
global inh311_cvoinstancevar inh311_cvoinstancevar
...
on inh311_cvoinstancevar.create
appname="inh311_cvoinstancevar"
...
on inh311_cvoinstancevar.destroy
destroy(sqlca)
destroy(sqlda)
destroy(sqlsa)
destroy(error)
