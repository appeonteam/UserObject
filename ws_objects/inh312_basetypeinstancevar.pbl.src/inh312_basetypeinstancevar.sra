$PBExportHeader$inh312_basetypeinstancevar.sra
$PBExportComments$Generated Application Object
forward
global type inh312_basetypeinstancevar from application
end type
...
string  gs_WinName[] = {"w_inh312w01_basetype"}
//END_GLOBALVAR
end variables

global type inh312_basetypeinstancevar from application
string appname = "inh312_basetypeinstancevar"
event ue_cotopen ( string as_commandline )
end type
global inh312_basetypeinstancevar inh312_basetypeinstancevar
...
on inh312_basetypeinstancevar.create
appname="inh312_basetypeinstancevar"
...
on inh312_basetypeinstancevar.destroy
destroy(sqlca)
destroy(sqlda)
destroy(sqlsa)
destroy(error)
