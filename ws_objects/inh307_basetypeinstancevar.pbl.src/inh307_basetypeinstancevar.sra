$PBExportHeader$inh307_basetypeinstancevar.sra
$PBExportComments$Generated Application Object
forward
global type inh307_basetypeinstancevar from application
end type
...
string  gs_WinName[] = {"w_inh307w01_datastore"}
//END_GLOBALVAR
end variables

global type inh307_basetypeinstancevar from application
string appname = "inh307_basetypeinstancevar"
event ue_cotopen ( string as_commandline )
end type
global inh307_basetypeinstancevar inh307_basetypeinstancevar
...
on inh307_basetypeinstancevar.create
appname="inh307_basetypeinstancevar"
...
on inh307_basetypeinstancevar.destroy
destroy(sqlca)
destroy(sqlda)
destroy(sqlsa)
destroy(error)
