$PBExportHeader$w_inh307w01_datastore.srw
forward
global type w_inh307w01_datastore from window
end type
type cb_3 from commandbutton within w_inh307w01_datastore
end type
type cb_2 from commandbutton within w_inh307w01_datastore
end type
type cb_execute from commandbutton within w_inh307w01_datastore
end type
type lb_items from listbox within w_inh307w01_datastore
end type
type cb_clear from commandbutton within w_inh307w01_datastore
end type
type cb_close from commandbutton within w_inh307w01_datastore
end type
type mle_output from multilineedit within w_inh307w01_datastore
end type
type mle_view from multilineedit within w_inh307w01_datastore
end type
type gb_3 from groupbox within w_inh307w01_datastore
end type
type gb_4 from groupbox within w_inh307w01_datastore
end type
type gb_5 from groupbox within w_inh307w01_datastore
end type
type mle_describe from multilineedit within w_inh307w01_datastore
end type
type gb_1 from groupbox within w_inh307w01_datastore
end type
end forward
...
string title = "Call SCO Base Data Type"
...
global w_inh307w01_datastore w_inh307w01_datastore
...
mle_describe.text += "2.Testing Purpose : Call SCO Base Data Type of Level 3" // This must include
...
Choose Case ls_item
	Case 'INH307W01P001'
		If ab_execute Then
			//Output String Type Variables(iuo_ds)
			Wf_Output('Test Point : ' + ls_item, True)
			Wf_Output('Describe   : ' + ls_descript, False)		
			Wf_Output('Output     : iuo_ds.is_1 = ~'' + iuo_ds.is_1 + '~'', False)
			Wf_Output('Output     : iuo_ds.is_2 = ~'' + iuo_ds.is_2 + '~'', False)
			Wf_Output('Output     : iuo_ds.is_3 = ~'' + iuo_ds.is_3 + '~'', False)
			Wf_Output('Output     : iuo_ds.is_4 = ~'' + iuo_ds.is_4 + '~'', False)
			Wf_Output('Output     : iuo_ds.is_5 = ~'' + iuo_ds.is_5 + '~'', False)
			Wf_Output('Output     : iuo_ds.is_6 = ~'' + iuo_ds.is_6 + '~'', False)
			Wf_Output('Output     : iuo_ds.is_7 = ~'' + iuo_ds.is_7 + '~'', False)
			Wf_Output('Output     : iuo_ds.is_8 = ~'' + iuo_ds.is_8 + '~'', False)
		Else
			wf_scriptview("//Output String Type Variables(iuo_ds)                                   ")
			wf_scriptview("Wf_Output('Test Point : ' + ls_item, True)                                  ")
			wf_scriptview("Wf_Output('Describe   : ' + ls_descript, False)                             ")
			wf_scriptview("Wf_Output('Output     : iuo_ds.is_1 = ~'' + iuo_ds.is_1 + '~'', False)")
			wf_scriptview("Wf_Output('Output     : iuo_ds.is_2 = ~'' + iuo_ds.is_2 + '~'', False)")
			wf_scriptview("Wf_Output('Output     : iuo_ds.is_3 = ~'' + iuo_ds.is_3 + '~'', False)")
			wf_scriptview("Wf_Output('Output     : iuo_ds.is_4 = ~'' + iuo_ds.is_4 + '~'', False)")
			wf_scriptview("Wf_Output('Output     : iuo_ds.is_5 = ~'' + iuo_ds.is_5 + '~'', False)")
			wf_scriptview("Wf_Output('Output     : iuo_ds.is_6 = ~'' + iuo_ds.is_6 + '~'', False)")
			wf_scriptview("Wf_Output('Output     : iuo_ds.is_7 = ~'' + iuo_ds.is_7 + '~'', False)")
			wf_scriptview("Wf_Output('Output     : iuo_ds.is_8 = ~'' + iuo_ds.is_8 + '~'', False)")
	...
	Case 'INH307W01P002'
		If ab_execute Then
			//Output Integer Type Variables(iuo_ds)
			Wf_Output('Test Point : ' + ls_item, True)
			Wf_Output('Describe   : ' + ls_descript, False)		
			Wf_Output('Output     : iuo_ds.ii_1 = ' + String(iuo_ds.ii_1), False)
			Wf_Output('Output     : iuo_ds.ii_2 = ' + String(iuo_ds.ii_2), False)
			Wf_Output('Output     : iuo_ds.ii_3 = ' + String(iuo_ds.ii_3), False)
			Wf_Output('Output     : iuo_ds.ii_4 = ' + String(iuo_ds.ii_4), False)
			Wf_Output('Output     : iuo_ds.ii_5 = ' + String(iuo_ds.ii_5), False)
			Wf_Output('Output     : iuo_ds.ii_6 = ' + String(iuo_ds.ii_6), False)
			Wf_Output('Output     : iuo_ds.ii_7 = ' + String(iuo_ds.ii_7), False)
			Wf_Output('Output     : iuo_ds.ii_8 = ' + String(iuo_ds.ii_8), False)
		Else
			wf_scriptview("//Output Integer Type Variables(iuo_ds)                                 ")
			wf_scriptview("Wf_Output('Test Point : ' + ls_item, True)                                 ")
			wf_scriptview("Wf_Output('Describe   : ' + ls_descript, False)                            ")
			wf_scriptview("Wf_Output('Output     : iuo_ds.ii_1 = ' + String(iuo_ds.ii_1), False)")
			wf_scriptview("Wf_Output('Output     : iuo_ds.ii_2 = ' + String(iuo_ds.ii_2), False)")
			wf_scriptview("Wf_Output('Output     : iuo_ds.ii_3 = ' + String(iuo_ds.ii_3), False)")
			wf_scriptview("Wf_Output('Output     : iuo_ds.ii_4 = ' + String(iuo_ds.ii_4), False)")
			wf_scriptview("Wf_Output('Output     : iuo_ds.ii_5 = ' + String(iuo_ds.ii_5), False)")
			wf_scriptview("Wf_Output('Output     : iuo_ds.ii_6 = ' + String(iuo_ds.ii_6), False)")
			wf_scriptview("Wf_Output('Output     : iuo_ds.ii_7 = ' + String(iuo_ds.ii_7), False)")
			wf_scriptview("Wf_Output('Output     : iuo_ds.ii_8 = ' + String(iuo_ds.ii_8), False)")
	...
	Case 'INH307W01P003'
		If ab_execute Then
			//Output Decimal Type Variables(iuo_ds)
			Wf_Output('Test Point : ' + ls_item, True)
			Wf_Output('Describe   : ' + ls_descript, False)		
			Wf_Output('Output     : iuo_ds.idec_1 = ' + String(iuo_ds.idec_1), False)
			Wf_Output('Output     : iuo_ds.idec_2 = ' + String(iuo_ds.idec_2), False)
			Wf_Output('Output     : iuo_ds.idec_3 = ' + String(iuo_ds.idec_3), False)
			Wf_Output('Output     : iuo_ds.idec_4 = ' + String(iuo_ds.idec_4), False)
			Wf_Output('Output     : iuo_ds.idec_5 = ' + String(iuo_ds.idec_5), False)
			Wf_Output('Output     : iuo_ds.idec_6 = ' + String(iuo_ds.idec_6), False)
			Wf_Output('Output     : iuo_ds.idec_7 = ' + String(iuo_ds.idec_7), False)
			Wf_Output('Output     : iuo_ds.idec_8 = ' + String(iuo_ds.idec_8), False)
		Else
			wf_scriptview("//Output Decimal Type Variables(iuo_ds)                                     ")
			wf_scriptview("Wf_Output('Test Point : ' + ls_item, True)                                     ")
			wf_scriptview("Wf_Output('Describe   : ' + ls_descript, False)                                ")
			wf_scriptview("Wf_Output('Output     : iuo_ds.idec_1 = ' + String(iuo_ds.idec_1), False)")
			wf_scriptview("Wf_Output('Output     : iuo_ds.idec_2 = ' + String(iuo_ds.idec_2), False)")
			wf_scriptview("Wf_Output('Output     : iuo_ds.idec_3 = ' + String(iuo_ds.idec_3), False)")
			wf_scriptview("Wf_Output('Output     : iuo_ds.idec_4 = ' + String(iuo_ds.idec_4), False)")
			wf_scriptview("Wf_Output('Output     : iuo_ds.idec_5 = ' + String(iuo_ds.idec_5), False)")
			wf_scriptview("Wf_Output('Output     : iuo_ds.idec_6 = ' + String(iuo_ds.idec_6), False)")
			wf_scriptview("Wf_Output('Output     : iuo_ds.idec_7 = ' + String(iuo_ds.idec_7), False)")
			wf_scriptview("Wf_Output('Output     : iuo_ds.idec_8 = ' + String(iuo_ds.idec_8), False)")
	...
	Case 'INH307W01P004'
		If ab_execute Then
			//Output Boolean Type Variables(iuo_ds)
			Wf_Output('Test Point : ' + ls_item, True)
			Wf_Output('Describe   : ' + ls_descript, False)				
			Wf_Output('Output     : iuo_ds.ib_1 = ' + wf_BoolToString(iuo_ds.ib_1), False)
			Wf_Output('Output     : iuo_ds.ib_2 = ' + wf_BoolToString(iuo_ds.ib_2), False)
			Wf_Output('Output     : iuo_ds.ib_3 = ' + wf_BoolToString(iuo_ds.ib_3), False)
			Wf_Output('Output     : iuo_ds.ib_4 = ' + wf_BoolToString(iuo_ds.ib_4), False)
			Wf_Output('Output     : iuo_ds.ib_5 = ' + wf_BoolToString(iuo_ds.ib_5), False)
			Wf_Output('Output     : iuo_ds.ib_6 = ' + wf_BoolToString(iuo_ds.ib_6), False)
			Wf_Output('Output     : iuo_ds.ib_7 = ' + wf_BoolToString(iuo_ds.ib_7), False)
			Wf_Output('Output     : iuo_ds.ib_8 = ' + wf_BoolToString(iuo_ds.ib_8), False)
		Else
			wf_scriptview("//Output Boolean Type Variables(iuo_ds)                                          ")
			wf_scriptview("Wf_Output('Test Point : ' + ls_item, True)                                          ")
			wf_scriptview("Wf_Output('Describe   : ' + ls_descript, False)                                     ")
			wf_scriptview("Wf_Output('Output     : iuo_ds.ib_1 = ' + wf_BoolToString(iuo_ds.ib_1), False)")
			wf_scriptview("Wf_Output('Output     : iuo_ds.ib_2 = ' + wf_BoolToString(iuo_ds.ib_2), False)")
			wf_scriptview("Wf_Output('Output     : iuo_ds.ib_3 = ' + wf_BoolToString(iuo_ds.ib_3), False)")
			wf_scriptview("Wf_Output('Output     : iuo_ds.ib_4 = ' + wf_BoolToString(iuo_ds.ib_4), False)")
			wf_scriptview("Wf_Output('Output     : iuo_ds.ib_5 = ' + wf_BoolToString(iuo_ds.ib_5), False)")
			wf_scriptview("Wf_Output('Output     : iuo_ds.ib_6 = ' + wf_BoolToString(iuo_ds.ib_6), False)")
			wf_scriptview("Wf_Output('Output     : iuo_ds.ib_7 = ' + wf_BoolToString(iuo_ds.ib_7), False)")
			wf_scriptview("Wf_Output('Output     : iuo_ds.ib_8 = ' + wf_BoolToString(iuo_ds.ib_8), False)")
	...
	Case 'INH307W01P005'
		If ab_execute Then
			//Output DateTime Type Variables(iuo_ds)
			Wf_Output('Test Point : ' + ls_item, True)
			Wf_Output('Describe   : ' + ls_descript, False)		
			Wf_Output('Output     : iuo_ds.idt_1 = ' + String(iuo_ds.idt_1), False)
			Wf_Output('Output     : iuo_ds.idt_2 = ' + String(iuo_ds.idt_2), False)
			Wf_Output('Output     : iuo_ds.idt_3 = ' + String(iuo_ds.idt_3), False)
			Wf_Output('Output     : iuo_ds.idt_4 = ' + String(iuo_ds.idt_4), False)
			Wf_Output('Output     : iuo_ds.idt_5 = ' + String(iuo_ds.idt_5), False)
			Wf_Output('Output     : iuo_ds.idt_6 = ' + String(iuo_ds.idt_6), False)
			Wf_Output('Output     : iuo_ds.idt_7 = ' + String(iuo_ds.idt_7), False)
			Wf_Output('Output     : iuo_ds.idt_8 = ' + String(iuo_ds.idt_8), False)
		Else
			wf_scriptview("//Output DateTime Type Variables(iuo_ds)                                  ")
			wf_scriptview("Wf_Output('Test Point : ' + ls_item, True)                                   ")
			wf_scriptview("Wf_Output('Describe   : ' + ls_descript, False)                              ")
			wf_scriptview("Wf_Output('Output     : iuo_ds.idt_1 = ' + String(iuo_ds.idt_1), False)")
			wf_scriptview("Wf_Output('Output     : iuo_ds.idt_2 = ' + String(iuo_ds.idt_2), False)")
			wf_scriptview("Wf_Output('Output     : iuo_ds.idt_3 = ' + String(iuo_ds.idt_3), False)")
			wf_scriptview("Wf_Output('Output     : iuo_ds.idt_4 = ' + String(iuo_ds.idt_4), False)")
			wf_scriptview("Wf_Output('Output     : iuo_ds.idt_5 = ' + String(iuo_ds.idt_5), False)")
			wf_scriptview("Wf_Output('Output     : iuo_ds.idt_6 = ' + String(iuo_ds.idt_6), False)")
			wf_scriptview("Wf_Output('Output     : iuo_ds.idt_7 = ' + String(iuo_ds.idt_7), False)")
			wf_scriptview("Wf_Output('Output     : iuo_ds.idt_8 = ' + String(iuo_ds.idt_8), False)")
	...
	Case 'INH307W01P006'
		If ab_execute Then
			//Output Any Type Variables(iuo_ds)
			Wf_Output('Test Point : ' + ls_item, True)
			Wf_Output('Describe   : ' + ls_descript, False)		
			Wf_Output('Output     : iuo_ds.ia_01 = ' + String(iuo_ds.ia_01), False)
			Wf_Output('Output     : iuo_ds.ia_02 = ' + String(iuo_ds.ia_02), False)
			Wf_Output('Output     : iuo_ds.ia_03 = ' + String(iuo_ds.ia_03), False)
			Wf_Output('Output     : iuo_ds.ia_04 = ' + String(iuo_ds.ia_04), False)
			Wf_Output('Output     : iuo_ds.ia_05 = ' + String(iuo_ds.ia_05), False)
			Wf_Output('Output     : iuo_ds.ia_06 = ' + String(iuo_ds.ia_06), False)
			Wf_Output('Output     : iuo_ds.ia_07 = ' + String(iuo_ds.ia_07), False)
			Wf_Output('Output     : iuo_ds.ia_08 = ' + String(iuo_ds.ia_08), False)
		Else
			wf_scriptview("//Output Any Type Variables(iuo_ds)                                       ")
			wf_scriptview("Wf_Output('Test Point : ' + ls_item, True)                                   ")
			wf_scriptview("Wf_Output('Describe   : ' + ls_descript, False)                              ")
			wf_scriptview("Wf_Output('Output     : iuo_ds.ia_01 = ' + String(iuo_ds.ia_01), False)")
			wf_scriptview("Wf_Output('Output     : iuo_ds.ia_02 = ' + String(iuo_ds.ia_02), False)")
			wf_scriptview("Wf_Output('Output     : iuo_ds.ia_03 = ' + String(iuo_ds.ia_03), False)")
			wf_scriptview("Wf_Output('Output     : iuo_ds.ia_04 = ' + String(iuo_ds.ia_04), False)")
			wf_scriptview("Wf_Output('Output     : iuo_ds.ia_05 = ' + String(iuo_ds.ia_05), False)")
			wf_scriptview("Wf_Output('Output     : iuo_ds.ia_06 = ' + String(iuo_ds.ia_06), False)")
			wf_scriptview("Wf_Output('Output     : iuo_ds.ia_07 = ' + String(iuo_ds.ia_07), False)")
			wf_scriptview("Wf_Output('Output     : iuo_ds.ia_08 = ' + String(iuo_ds.ia_08), False)")
...
lb_items.additem("INH307W01P001: [ String ] Data Type")
lb_items.additem("INH307W01P002: [ Integer ] Data Type")
lb_items.additem("INH307W01P003: [ Decimal ] Data Type")
lb_items.additem("INH307W01P004: [ Boolean ] Data Type")
lb_items.additem("INH307W01P005: [ DateTime ] Data Type")
lb_items.additem("INH307W01P006: [ Any ] Data Type")
end subroutine
...
on w_inh307w01_datastore.create
...
on w_inh307w01_datastore.destroy
destroy(this.cb_3)
destroy(this.cb_2)
