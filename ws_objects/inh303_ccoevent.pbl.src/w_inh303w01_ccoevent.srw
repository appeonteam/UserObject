$PBExportHeader$w_inh303w01_ccoevent.srw
forward
global type w_inh303w01_ccoevent from window
end type
type cb_3 from commandbutton within w_inh303w01_ccoevent
end type
type cb_2 from commandbutton within w_inh303w01_ccoevent
end type
type cb_execute from commandbutton within w_inh303w01_ccoevent
end type
type lb_items from listbox within w_inh303w01_ccoevent
end type
type cb_clear from commandbutton within w_inh303w01_ccoevent
end type
type cb_close from commandbutton within w_inh303w01_ccoevent
end type
type mle_output from multilineedit within w_inh303w01_ccoevent
end type
type mle_view from multilineedit within w_inh303w01_ccoevent
end type
type gb_3 from groupbox within w_inh303w01_ccoevent
end type
type gb_4 from groupbox within w_inh303w01_ccoevent
end type
type gb_5 from groupbox within w_inh303w01_ccoevent
end type
type mle_describe from multilineedit within w_inh303w01_ccoevent
end type
type gb_1 from groupbox within w_inh303w01_ccoevent
end type
end forward
...
global w_inh303w01_ccoevent w_inh303w01_ccoevent
...
mle_describe.text += "2.Testing Purpose : Calling CCO Event of Level 3" // This must include
...
Choose Case ls_item
	Case 'INH303W01P001'
		...
		Else
			...
			wf_scriptview("                                               ")
			wf_scriptview("in_cst_L3.Event ue_point_1()                     ")
	...
	Case 'INH303W01P002'
		...
		Else
			...
			wf_scriptview("Wf_Output('Describe   : ' + ls_descript, False)")
			wf_scriptview("                                               ")
			wf_scriptview("in_cst_L3.Event ue_point_2()                     ")
	...
	Case 'INH303W01P003'
		...
		Else
			...
			wf_scriptview("Wf_Output('Describe   : ' + ls_descript, False)")
			wf_scriptview("                                               ")
			wf_scriptview("in_cst_L3.Event ue_point_3()                     ")
	...
	Case 'INH303W01P004'
		...
		Else
			...
			wf_scriptview("Wf_Output('Describe   : ' + ls_descript, False)")
			wf_scriptview("                                               ")
			wf_scriptview("in_cst_L3.Event ue_point_4()                     ")
	...
	Case 'INH303W01P005'
		...
		Else
			...
			wf_scriptview("Wf_Output('Describe   : ' + ls_descript, False)")
			wf_scriptview("                                               ")
			wf_scriptview("in_cst_L3.Event ue_point_5()                     ")
	...
	Case 'INH303W01P006'
		...
		Else
			...
			wf_scriptview("Wf_Output('Describe   : ' + ls_descript, False)")
			wf_scriptview("                                               ")
			wf_scriptview("in_cst_L3.Event ue_point_6()                     ")
	...
	Case 'INH303W01P007'
		...
		Else
			...
			wf_scriptview("Wf_Output('Describe   : ' + ls_descript, False)")
			wf_scriptview("                                               ")
			wf_scriptview("in_cst_L3.Event ue_point_7()                     ")
...
lb_items.additem("INH303W01P001: 1th Code,2th Code Override,3th Code Override.")
lb_items.additem("INH303W01P002: 1th Code,2th Uncode Extend,3th Code Override.")
lb_items.additem("INH303W01P003: 1th Code,2th Code Extend,3th Code Extend.")
lb_items.additem("INH303W01P004: 1th Uncode,2th Code Override,3th Code Override.")
lb_items.additem("INH303W01P005: 1th Uncode,2th Uncode Extend,3th Code Override.")
lb_items.additem("INH303W01P006: 1th Uncode,2th Code Extend,3th Code Extend.")
lb_items.additem("INH303W01P007: 1th Undefine,2th Code,3th Code Extend.")
end subroutine
...
on w_inh303w01_ccoevent.create
...
on w_inh303w01_ccoevent.destroy
destroy(this.cb_3)
destroy(this.cb_2)
...
event open;gw_inh303w01_ccoevent = this
