$PBExportHeader$w_inh305w01_autouo.srw
forward
global type w_inh305w01_autouo from window
end type
type cb_3 from commandbutton within w_inh305w01_autouo
end type
type cb_2 from commandbutton within w_inh305w01_autouo
end type
type cb_execute from commandbutton within w_inh305w01_autouo
end type
type lb_items from listbox within w_inh305w01_autouo
end type
type cb_clear from commandbutton within w_inh305w01_autouo
end type
type cb_close from commandbutton within w_inh305w01_autouo
end type
type mle_output from multilineedit within w_inh305w01_autouo
end type
type mle_view from multilineedit within w_inh305w01_autouo
end type
type gb_3 from groupbox within w_inh305w01_autouo
end type
type gb_4 from groupbox within w_inh305w01_autouo
end type
type gb_5 from groupbox within w_inh305w01_autouo
end type
type mle_describe from multilineedit within w_inh305w01_autouo
end type
type gb_1 from groupbox within w_inh305w01_autouo
end type
end forward
...
string title = "CCO Instance Variables"
...
global w_inh305w01_autouo w_inh305w01_autouo

type variables
//OutPut Index 
Integer ii_index = 0

n_cst_inh305_L2	in_cst_L2
...
mle_describe.text += "2.Testing Purpose : Calling CCO Instance Variables" // This must include
mle_describe.text += "~r~n"
mle_describe.text += "3.Operation Step : ~r~n" // Optional
mle_describe.text += ""
mle_describe.text += "4.Object / Variables Declare : ~r~n" // Optional
mle_describe.text += "	        1).n_cstinh305_L1 is is NOT AutoInstantiate.~r~n"
mle_describe.text += "	        2).n_cstinh305_L1 Declare Variables : String is_L1; Long il_L1.~r~n"
mle_describe.text += "	        3).n_cstinh305_L2 inherited from n_cstinh305_L1.~r~n"
mle_describe.text += "	        4).n_cstinh305_L2 is AutoInstantiate.~r~n"
...
Choose Case ls_item
	Case 'INH305W01P001'
		If ab_execute Then
			...
			Wf_OutPut('Output     : in_cst_L2.is_L1 = ~"' + in_cst_L2.is_L1 + '~"', False)
			Wf_OutPut('Output     : in_cst_L2.il_L1 = ' + String(in_cst_L2.il_L1), False)
		Else
			wf_scriptview("//Output Instance Variables                                                   ")
			wf_scriptview("in_cst_L2.is_L1 = 'L1'                                                        ")
			wf_scriptview("in_cst_L2.il_L1 = 1                                                           ")
			wf_scriptview("                                                                              ")
			wf_scriptview("Wf_Output('Test Point : ' + ls_item, True)                                    ")
			wf_scriptview("Wf_Output('Describe   : ' + ls_descript, False)                               ")
			wf_scriptview("                                                                              ")
			wf_scriptview("Wf_OutPut('Output     : in_cst_L2.is_L1 = ~"' + in_cst_L2.is_L1 + '~"', False)")
			wf_scriptview("Wf_OutPut('Output     : in_cst_L2.il_L1 = ' + String(in_cst_L2.il_L1), False) ")
...
lb_items.additem("INH305W01P001: Calling CCO Instance Variables")
end subroutine
