$PBExportHeader$w_inh313w01_property.srw
forward
global type w_inh313w01_property from window
end type
type cb_2 from commandbutton within w_inh313w01_property
end type
type cb_3 from commandbutton within w_inh313w01_property
end type
type uo_1 from u_cst_inh313_l3 within w_inh313w01_property
end type
type cb_execute from commandbutton within w_inh313w01_property
end type
type lb_items from listbox within w_inh313w01_property
end type
type cb_clear from commandbutton within w_inh313w01_property
end type
type cb_close from commandbutton within w_inh313w01_property
end type
type mle_output from multilineedit within w_inh313w01_property
end type
type mle_view from multilineedit within w_inh313w01_property
end type
type gb_3 from groupbox within w_inh313w01_property
end type
type gb_4 from groupbox within w_inh313w01_property
end type
type gb_5 from groupbox within w_inh313w01_property
end type
type mle_describe from multilineedit within w_inh313w01_property
end type
type gb_1 from groupbox within w_inh313w01_property
end type
type gb_2 from groupbox within w_inh313w01_property
end type
end forward
...
string title = "Call CVO Property"
...
global w_inh313w01_property w_inh313w01_property
...
mle_describe.text += "2.Testing Purpose : Calling CVO Property of Level 3" // This must include
...
Choose Case ls_item
	...
	Case 'INH313W01P001'
		If ab_execute Then
			...
			Wf_Output('OUTPUT     : uo_1.BackColor = ' + String(uo_1.BackColor) , False)
		End If
	//Enabled
	Case 'INH313W01P002'
		If ab_execute Then
			Wf_Output('Test Point : ' + ls_item, True)
			Wf_Output('Describe   : ' + ls_descript, False)
			Wf_Output('OUTPUT     : uo_1.Enabled = ' + wf_BoolToString(uo_1.Enabled), False)
		End If
	//Border
	Case 'INH313W01P003'
		If ab_execute Then
			Wf_Output('Test Point : ' + ls_item, True)
			Wf_Output('Describe   : ' + ls_descript, False)
			Wf_Output('OUTPUT     : uo_1.Border = ' + wf_BoolToString(uo_1.Border), False)
		End If
	//Tag
	Case 'INH313W01P004'
		If ab_execute Then
			Wf_Output('Test Point : ' + ls_item, True)
			Wf_Output('Describe   : ' + ls_descript, False)
			Wf_Output('OUTPUT     : uo_1.Tag = ~"' + uo_1.Tag + '~"', False)
		End If
...
End Choose
mle_View.Text = ""
wf_scriptview("//L1 init Property         ")
wf_scriptview("enabled = false")
wf_scriptview("tag = 'L1'     ")
wf_scriptview("               ")
wf_scriptview("//L2 init Property          ")
wf_scriptview("tag = 'L1L2'   ")
wf_scriptview("border = true  ")
wf_scriptview("               ")
wf_scriptview("//L3 init Property          ")
wf_scriptview("tag = 'L1L2L3' ")
...
lb_items.additem("INH313W01P001: [ BackColor ] Property, All NOT Modify")
lb_items.additem("INH313W01P002: [ Enabled ] Property, Level 1 Modify, Level 2,3 NOT Modify")
lb_items.additem("INH313W01P003: [ Border ] Property, Level 2 Modify, Level 1,2 NOT Modify")
lb_items.additem("INH313W01P004: [ Tag ] Property, All Modify")
end subroutine

public function string wf_booltostring (boolean ab_args);//Convert Boolean Type to String Type
If ab_args Then
	Return "TRUE"
Else
	Return "FALSE"
...
on w_inh313w01_property.create
...
on w_inh313w01_property.destroy
destroy(this.cb_2)
destroy(this.cb_3)
destroy(this.uo_1)
