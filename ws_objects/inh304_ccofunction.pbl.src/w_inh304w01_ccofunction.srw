$PBExportHeader$w_inh304w01_ccofunction.srw
forward
global type w_inh304w01_ccofunction from window
end type
type cb_3 from commandbutton within w_inh304w01_ccofunction
end type
type cb_2 from commandbutton within w_inh304w01_ccofunction
end type
type cb_execute from commandbutton within w_inh304w01_ccofunction
end type
type lb_items from listbox within w_inh304w01_ccofunction
end type
type cb_clear from commandbutton within w_inh304w01_ccofunction
end type
type cb_close from commandbutton within w_inh304w01_ccofunction
end type
type mle_output from multilineedit within w_inh304w01_ccofunction
end type
type mle_view from multilineedit within w_inh304w01_ccofunction
end type
type gb_3 from groupbox within w_inh304w01_ccofunction
end type
type gb_4 from groupbox within w_inh304w01_ccofunction
end type
type gb_5 from groupbox within w_inh304w01_ccofunction
end type
type mle_describe from multilineedit within w_inh304w01_ccofunction
end type
type gb_1 from groupbox within w_inh304w01_ccofunction
end type
end forward
...
string title = "Call CCO Function"
...
global w_inh304w01_ccofunction w_inh304w01_ccofunction
...
mle_describe.text += "2.Testing Purpose : Calling CCO Function of Level 3" // This must include
...
Choose Case ls_item
	Case 'INH304W01P001'
		...
		Else
			...
			wf_scriptview("                                               ")
			wf_scriptview("in_cst_L3.Function uf_point_1()                     ")
	...
	Case 'INH304W01P002'
		...
		Else
			...
			wf_scriptview("Wf_Output('Describe   : ' + ls_descript, False)")
			wf_scriptview("                                               ")
			wf_scriptview("in_cst_L3.Function uf_point_2()                     ")
	...
	Case 'INH304W01P003'
		...
		Else
			...
			wf_scriptview("Wf_Output('Describe   : ' + ls_descript, False)")
			wf_scriptview("                                               ")
			wf_scriptview("in_cst_L3.Function uf_point_3()                     ")
	...
	Case 'INH304W01P004'
		...
		Else
			...
			wf_scriptview("Wf_Output('Describe   : ' + ls_descript, False)")
			wf_scriptview("                                               ")
			wf_scriptview("in_cst_L3.Function uf_point_4()                     ")
	...
	Case 'INH304W01P005'
		...
		Else
			...
			wf_scriptview("Wf_Output('Describe   : ' + ls_descript, False)")
			wf_scriptview("                                               ")
			wf_scriptview("in_cst_L3.Function uf_point_5()                     ")
	...
	Case 'INH304W01P006'
		...
		Else
			...
			wf_scriptview("Wf_Output('Describe   : ' + ls_descript, False)")
			wf_scriptview("                                               ")
			wf_scriptview("in_cst_L3.Function uf_point_6()                     ")
...
lb_items.additem("INH304W01P001: 1th Code,2th Code Override,3th Code Override.")
lb_items.additem("INH304W01P002: 1th Code,2th Code Override,3th NO Code.")
lb_items.additem("INH304W01P003: 1th Code,2th NO Code,3th NO Code")
lb_items.additem("INH304W01P004: 1th Code,2th Overload,3th Overload.")
lb_items.additem("INH304W01P005: 1th Code,2th Overload,3th Override 1th.")
lb_items.additem("INH304W01P006: 1th Undefine,2th Code, 3th NO Code.")
end subroutine
...
on w_inh304w01_ccofunction.create
...
on w_inh304w01_ccofunction.destroy
destroy(this.cb_3)
destroy(this.cb_2)
...
event open;gw_inh304w01_ccofunction = this
