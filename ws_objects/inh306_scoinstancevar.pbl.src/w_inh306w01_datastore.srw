$PBExportHeader$w_inh306w01_datastore.srw
forward
global type w_inh306w01_datastore from window
end type
type cb_3 from commandbutton within w_inh306w01_datastore
end type
type cb_2 from commandbutton within w_inh306w01_datastore
end type
type cb_execute from commandbutton within w_inh306w01_datastore
end type
type lb_items from listbox within w_inh306w01_datastore
end type
type cb_clear from commandbutton within w_inh306w01_datastore
end type
type cb_close from commandbutton within w_inh306w01_datastore
end type
type mle_output from multilineedit within w_inh306w01_datastore
end type
type mle_view from multilineedit within w_inh306w01_datastore
end type
type gb_3 from groupbox within w_inh306w01_datastore
end type
type gb_4 from groupbox within w_inh306w01_datastore
end type
type gb_5 from groupbox within w_inh306w01_datastore
end type
type mle_describe from multilineedit within w_inh306w01_datastore
end type
type gb_1 from groupbox within w_inh306w01_datastore
end type
end forward
...
string title = "Call SCO Instance Variables"
...
global w_inh306w01_datastore w_inh306w01_datastore
...
mle_describe.text += "2.Testing Purpose : Calling SCO Instance Variables" // This must include
...
Choose Case ls_item
	Case 'INH306W01P001'
		If ab_execute Then
			...
			Wf_Output('String     : iuo_ds.is_L1 = ~"' + iuo_ds.is_L1 + '~"', False)
			Wf_Output('Array      : iuo_ds.il_L1[1] = ' + String(iuo_ds.il_L1[1]), False)
			Wf_Output('Structure  : iuo_ds.istr_L1.sl_Long = ' + String(iuo_ds.istr_L1.sl_Long), False)
			Wf_Output('Structure  : iuo_ds.istr_L1.ss_String  = ~"' + iuo_ds.istr_L1.ss_String  + '~"', False)
			Wf_Output('Control    : iuo_ds.icb_L1  = ~"' + iuo_ds.icb_L1.Text  + '~"', False)
			Wf_Output('SYS Object : iuo_ds.itr_L1.ServerName  = ~"' + iuo_ds.itr_L1.ServerName  + '~"', False)
			Wf_Output('AutoInstantiate   : iuo_ds.invo_L1_Auto.is_String  = ~"' + iuo_ds.invo_L1_Auto.is_String  + '~"', False)
			Wf_Output('UNAutoInstantiate : iuo_ds.invo_L1_Unauto.is_String  = ~"' + iuo_ds.invo_L1_Unauto.is_String  + '~"', False)
		Else
			...
			wf_scriptview("Wf_Output('String     : iuo_ds.is_L1 = ~"' + iuo_ds.is_L1 + '~"', False)                                               ")
			wf_scriptview("Wf_Output('Array      : iuo_ds.il_L1[1] = ' + String(iuo_ds.il_L1[1]), False)                                          ")
			wf_scriptview("Wf_Output('Structure  : iuo_ds.istr_L1.sl_Long = ' + String(iuo_ds.istr_L1.sl_Long), False)                            ")
			wf_scriptview("Wf_Output('Structure  : iuo_ds.istr_L1.ss_String  = ~"' + iuo_ds.istr_L1.ss_String  + '~"', False)                     ")
			wf_scriptview("Wf_Output('Control    : iuo_ds.icb_L1  = ~"' + iuo_ds.icb_L1.Text  + '~"', False)                                      ")
			wf_scriptview("Wf_Output('SYS Object : iuo_ds.itr_L1.ServerName  = ~"' + iuo_ds.itr_L1.ServerName  + '~"', False)                     ")
			wf_scriptview("Wf_Output('AutoInstantiate   : iuo_ds.invo_L1_Auto.is_String  = ~"' + iuo_ds.invo_L1_Auto.is_String  + '~"', False)    ")
			wf_scriptview("Wf_Output('UNAutoInstantiate : iuo_ds.invo_L1_Unauto.is_String  = ~"' + iuo_ds.invo_L1_Unauto.is_String  + '~"', False)")
			wf_scriptview("")
			wf_scriptview("//Init Instance Varibles                         ")
			wf_scriptview("If NOT IsValid(W_INH306W01_DATASTORE) Then Return")
			wf_scriptview("//L1                                             ")
			...
			wf_scriptview("                                                 ")
			wf_scriptview("icb_L1 = W_INH306W01_DATASTORE.cb_Close          ")
			wf_scriptview("                                                 ")
	...
	Case 'INH306W01P002'
		If ab_execute Then
			...
			Wf_Output('Test Point : ' + ls_item, True)
			Wf_Output('Describe   : ' + ls_descript, False)
			Wf_Output('String     : iuo_ds.is_L2 = ~"' + iuo_ds.is_L2 + '~"', False)
			Wf_Output('Array      : iuo_ds.il_L2[1] = ' + String(iuo_ds.il_L2[1]), False)
			Wf_Output('Structure  : iuo_ds.istr_L2.sl_Long = ' + String(iuo_ds.istr_L2.sl_Long), False)
			Wf_Output('Structure  : iuo_ds.istr_L2.ss_String  = ~"' + iuo_ds.istr_L2.ss_String  + '~"', False)
			Wf_Output('Control    : iuo_ds.icb_L2  = ~"' + iuo_ds.icb_L2.Text  + '~"', False)
			Wf_Output('SYS Object : iuo_ds.itr_L2.ServerName  = ~"' + iuo_ds.itr_L2.ServerName  + '~"', False)
			Wf_Output('AutoInstantiate   : iuo_ds.invo_L2_Auto.is_String  = ~"' + iuo_ds.invo_L2_Auto.is_String  + '~"', False)
			Wf_Output('UNAutoInstantiate : iuo_ds.invo_L2_Unauto.is_String  = ~"' + iuo_ds.invo_L2_Unauto.is_String  + '~"', False)
		Else
			wf_scriptview("//Output Instance Variables of Level 2                                                                                 ")
			wf_scriptview("Wf_Output('Test Point : ' + ls_item, True)                                                                             ")
			wf_scriptview("Wf_Output('Describe   : ' + ls_descript, False)                                                                        ")
			wf_scriptview("Wf_Output('String     : iuo_ds.is_L2 = ~"' + iuo_ds.is_L2 + '~"', False)                                               ")
			wf_scriptview("Wf_Output('Array      : iuo_ds.il_L2[1] = ' + String(iuo_ds.il_L2[1]), False)                                          ")
			wf_scriptview("Wf_Output('Structure  : iuo_ds.istr_L2.sl_Long = ' + String(iuo_ds.istr_L2.sl_Long), False)                            ")
			wf_scriptview("Wf_Output('Structure  : iuo_ds.istr_L2.ss_String  = ~"' + iuo_ds.istr_L2.ss_String  + '~"', False)                     ")
			wf_scriptview("Wf_Output('Control    : iuo_ds.icb_L2  = ~"' + iuo_ds.icb_L2.Text  + '~"', False)                                      ")
			wf_scriptview("Wf_Output('SYS Object : iuo_ds.itr_L2.ServerName  = ~"' + iuo_ds.itr_L2.ServerName  + '~"', False)                     ")
			wf_scriptview("Wf_Output('AutoInstantiate   : iuo_ds.invo_L2_Auto.is_String  = ~"' + iuo_ds.invo_L2_Auto.is_String  + '~"', False)    ")
			wf_scriptview("Wf_Output('UNAutoInstantiate : iuo_ds.invo_L2_Unauto.is_String  = ~"' + iuo_ds.invo_L2_Unauto.is_String  + '~"', False)")
			wf_scriptview("")
			wf_scriptview("//Init Instance Varibles                         ")
			wf_scriptview("If NOT IsValid(W_INH306W01_DATASTORE) Then Return")
			wf_scriptview("//L2                                             ")
			...
			wf_scriptview("                                                 ")
			wf_scriptview("icb_L2 = W_INH306W01_DATASTORE.cb_Clear          ")
			wf_scriptview("                                                 ")
	...
	Case 'INH306W01P003'
		If ab_execute Then
			...
			Wf_Output('Test Point : ' + ls_item, True)
			Wf_Output('Describe   : ' + ls_descript, False)
			Wf_Output('String     : iuo_ds.is_L3 = ~"' + iuo_ds.is_L3 + '~"', False)
			Wf_Output('Array      : iuo_ds.il_L3[1] = ' + String(iuo_ds.il_L3[1]), False)
			Wf_Output('Structure  : iuo_ds.istr_L3.sl_Long = ' + String(iuo_ds.istr_L3.sl_Long), False)
			Wf_Output('Structure  : iuo_ds.istr_L3.ss_String  = ~"' + iuo_ds.istr_L3.ss_String  + '~"', False)
			Wf_Output('Control    : iuo_ds.icb_L3  = ~"' + iuo_ds.icb_L3.Text  + '~"', False)
			Wf_Output('SYS Object : iuo_ds.itr_L3.ServerName  = ~"' + iuo_ds.itr_L3.ServerName  + '~"', False)
			Wf_Output('AutoInstantiate   : iuo_ds.invo_L3_Auto.is_String  = ~"' + iuo_ds.invo_L3_Auto.is_String  + '~"', False)
			Wf_Output('UNAutoInstantiate : iuo_ds.invo_L3_Unauto.is_String  = ~"' + iuo_ds.invo_L3_Unauto.is_String  + '~"', False)
		Else
			wf_scriptview("//Output Instance Variables of Level 3                                                                                 ")
			wf_scriptview("Wf_Output('Test Point : ' + ls_item, True)                                                                             ")
			wf_scriptview("Wf_Output('Describe   : ' + ls_descript, False)                                                                        ")
			wf_scriptview("Wf_Output('String     : iuo_ds.is_L3 = ~"' + iuo_ds.is_L3 + '~"', False)                                               ")
			wf_scriptview("Wf_Output('Array      : iuo_ds.il_L3[1] = ' + String(iuo_ds.il_L3[1]), False)                                          ")
			wf_scriptview("Wf_Output('Structure  : iuo_ds.istr_L3.sl_Long = ' + String(iuo_ds.istr_L3.sl_Long), False)                            ")
			wf_scriptview("Wf_Output('Structure  : iuo_ds.istr_L3.ss_String  = ~"' + iuo_ds.istr_L3.ss_String  + '~"', False)                     ")
			wf_scriptview("Wf_Output('Control    : iuo_ds.icb_L3  = ~"' + iuo_ds.icb_L3.Text  + '~"', False)                                      ")
			wf_scriptview("Wf_Output('SYS Object : iuo_ds.itr_L3.ServerName  = ~"' + iuo_ds.itr_L3.ServerName  + '~"', False)                     ")
			wf_scriptview("Wf_Output('AutoInstantiate   : iuo_ds.invo_L3_Auto.is_String  = ~"' + iuo_ds.invo_L3_Auto.is_String  + '~"', False)    ")
			wf_scriptview("Wf_Output('UNAutoInstantiate : iuo_ds.invo_L3_Unauto.is_String  = ~"' + iuo_ds.invo_L3_Unauto.is_String  + '~"', False)")
			wf_scriptview("")
			wf_scriptview("//Init Instance Varibles                         ")
			wf_scriptview("If NOT IsValid(W_INH306W01_DATASTORE) Then Return")
			wf_scriptview("//L3                                             ")
			...
			wf_scriptview("                                                 ")
			wf_scriptview("icb_L3 = W_INH306W01_DATASTORE.cb_Execute        ")
			wf_scriptview("                                                 ")
...
lb_items.additem("INH306W01P001: Calling SCO Instance Variables(Level 1)")
lb_items.additem("INH306W01P002: Calling SCO Instance Variables(Level 2)")
lb_items.additem("INH306W01P003: Calling SCO Instance Variables(Level 3)")
end subroutine
...
on w_inh306w01_datastore.create
...
on w_inh306w01_datastore.destroy
destroy(this.cb_3)
destroy(this.cb_2)
...
event open;gw_inh306w01_datastore = this
