$PBExportHeader$inh306_scoinstancevar.sra
$PBExportComments$Generated Application Object
forward
global type inh306_scoinstancevar from application
end type
...
global variables
String gs_pb, gs_js
w_inh306w01_datastore gw_inh306w01_datastore
...
string  gs_WinName[] = {"w_inh306w01_datastore"}
//END_GLOBALVAR
end variables

global type inh306_scoinstancevar from application
string appname = "inh306_scoinstancevar"
event ue_cotopen ( string as_commandline )
end type
global inh306_scoinstancevar inh306_scoinstancevar
...
on inh306_scoinstancevar.create
appname="inh306_scoinstancevar"
...
on inh306_scoinstancevar.destroy
destroy(sqlca)
destroy(sqlda)
destroy(sqlsa)
destroy(error)
