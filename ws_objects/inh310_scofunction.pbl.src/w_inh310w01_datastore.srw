$PBExportHeader$w_inh310w01_datastore.srw
forward
global type w_inh310w01_datastore from window
end type
type cb_3 from commandbutton within w_inh310w01_datastore
end type
type cb_2 from commandbutton within w_inh310w01_datastore
end type
type cb_execute from commandbutton within w_inh310w01_datastore
end type
type lb_items from listbox within w_inh310w01_datastore
end type
type cb_clear from commandbutton within w_inh310w01_datastore
end type
type cb_close from commandbutton within w_inh310w01_datastore
end type
type mle_output from multilineedit within w_inh310w01_datastore
end type
type mle_view from multilineedit within w_inh310w01_datastore
end type
type gb_3 from groupbox within w_inh310w01_datastore
end type
type gb_4 from groupbox within w_inh310w01_datastore
end type
type gb_5 from groupbox within w_inh310w01_datastore
end type
type mle_describe from multilineedit within w_inh310w01_datastore
end type
type gb_1 from groupbox within w_inh310w01_datastore
end type
end forward
...
string title = "Call SCO Function"
...
global w_inh310w01_datastore w_inh310w01_datastore
...
mle_describe.text += "2.Testing Purpose : Calling SCO Function of Level 3" // This must include
...
Choose Case ls_item
	Case 'INH310W01P001'
		...
		Else
			...
			wf_scriptview("                                               ")
			wf_scriptview("iuo_ds.Function uf_point_1()                     ")
	...
	Case 'INH310W01P002'
		...
		Else
			...
			wf_scriptview("Wf_Output('Describe   : ' + ls_descript, False)")
			wf_scriptview("                                               ")
			wf_scriptview("iuo_ds.Function uf_point_2()                     ")
	...
	Case 'INH310W01P003'
		...
		Else
			...
			wf_scriptview("Wf_Output('Describe   : ' + ls_descript, False)")
			wf_scriptview("                                               ")
			wf_scriptview("iuo_ds.Function uf_point_3()                     ")
	...
	Case 'INH310W01P004'
		...
		Else
			...
			wf_scriptview("Wf_Output('Describe   : ' + ls_descript, False)")
			wf_scriptview("                                               ")
			wf_scriptview("iuo_ds.Function uf_point_4()                     ")
	...
	Case 'INH310W01P005'
		...
		Else
			...
			wf_scriptview("Wf_Output('Describe   : ' + ls_descript, False)")
			wf_scriptview("                                               ")
			wf_scriptview("iuo_ds.Function uf_point_5()                     ")
	...
	Case 'INH310W01P006'
		...
		Else
			...
			wf_scriptview("Wf_Output('Describe   : ' + ls_descript, False)")
			wf_scriptview("                                               ")
			wf_scriptview("iuo_ds.Function uf_point_6()                     ")
...
lb_items.additem("INH310W01P001: 1th Code,2th Code Override,3th Code Override.")
lb_items.additem("INH310W01P002: 1th Code,2th Code Override,3th NO Code.")
lb_items.additem("INH310W01P003: 1th Code,2th NO Code,3th NO Code")
lb_items.additem("INH310W01P004: 1th Code,2th Overload,3th Overload.")
lb_items.additem("INH310W01P005: 1th Code,2th Overload,3th Override 1th.")
lb_items.additem("INH310W01P006: 1th Undefine,2th Code, 3th NO Code.")
end subroutine
...
on w_inh310w01_datastore.create
...
on w_inh310w01_datastore.destroy
destroy(this.cb_3)
destroy(this.cb_2)
...
event open;gw_inh310w01_datastore = this
