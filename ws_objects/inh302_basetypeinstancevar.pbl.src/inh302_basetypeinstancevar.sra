$PBExportHeader$inh302_basetypeinstancevar.sra
$PBExportComments$Generated Application Object
forward
global type inh302_basetypeinstancevar from application
end type
...
string  gs_WinName[] = {"w_inh302w01_basetype"}
//END_GLOBALVAR
end variables

global type inh302_basetypeinstancevar from application
string appname = "inh302_basetypeinstancevar"
event ue_cotopen ( string as_commandline )
end type
global inh302_basetypeinstancevar inh302_basetypeinstancevar
...
on inh302_basetypeinstancevar.create
appname="inh302_basetypeinstancevar"
...
on inh302_basetypeinstancevar.destroy
destroy(sqlca)
destroy(sqlda)
destroy(sqlsa)
destroy(error)
